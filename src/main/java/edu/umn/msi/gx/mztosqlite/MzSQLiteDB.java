...
public class MzSQLiteDB {
    public static final String CREATE_Source_TABLE = "CREATE TABLE Source (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, name TEXT, format TEXT, spectrumIDFormat TEXT, location TEXT). entries INTEGER";
    ...
    public static final String CREATE_DBSequence_TABLE = "CREATE TABLE DBSequence ( pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, id INTEGER, SearchDatabase_pkid INTEGER REFERENCES SearchDatabase(pkid), accession TEXT, description TEXT, length INTEGER, sequence TEXT)";
    public static final String CREATE_PeptideEvidence_TABLE = "CREATE TABLE PeptideEvidence (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, SpectrumIdentification_pkid INTEGER REFERENCES SpectrumIdentification(pkid), Peptide_pkid INTEGER REFERENCES Peptide(pkid), DBSequence_pkid INTEGER REFERENCES DBSequence(pkid), isDecoy INTEGER, pre TEXT, post TEXT, start INTEGER, end INTEGER)";
    public static final String CREATE_Peptide_TABLE = "CREATE TABLE Peptide ( pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, sequence TEXT, modNum INTEGER)";
    public static final String CREATE_Modification_TABLE = "CREATE TABLE Modification (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, Peptide_pkid INTEGER REFERENCES Peptide(pkid),location INTEGER, residues TEXT, replacementResidue TEXT, name TEXT, avgMassDelta REAL, monoisotopicMassDelta REAL )";
    public static final String CREATE_SearchModification_TABLE = "CREATE TABLE SearchModification (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, name TEXT, residues TEXT, massDelta REAL, fixedMod INTEGER, accession TEXT,cvRef TEXT)";
   public static final String CREATE_Score_TABLE = "CREATE TABLE Score (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, spectrum_identification_id TEXT, SpectrumIdentification_pkid INTEGER REFERENCES SpectrumIdentification(pkid) )";
...
//    public static final String CREATE_Fragmentation_TABLE = "CREATE TABLE Fragmentation (pkid INTEGER PRIMARY KEY, spectrum_identification_id TEXT, charge INTEGER, index TEXT)";
    public static final String CREATE_Spectrum_TABLE = "CREATE TABLE Spectrum (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, id TEXT, title TEXT, acquisitionNum INTEGER, msLevel INTEGER, polarity INTEGER, peaksCount INTEGER, totIonCurrent REAL, retentionTime REAL, basePeakMZ REAL, basePeakIntensity REAL, collisionEnergy REAL, ionisationEnergy REAL, lowMZ REAL, highMZ REAL, precursorScanNum INTEGER, precursorMZ REAL, precursorCharge INTEGER, precursorIntensity REAL )";
    public static final String CREATE_Peaks_TABLE = "CREATE TABLE Peaks (pkid INTEGER PRIMARY KEY ASC AUTOINCREMENT, Spectrum_pkid INT REFERENCES Spectrum(pkid), acquisitionNum INTEGER, moz TEXT, intensity TEXT)";
    public static final String[] TABLE_DEFS = {CREATE_Source_TABLE, CREATE_SpectraData_TABLE, CREATE_SearchDatabase_TABLE, CREATE_DBSequence_TABLE, CREATE_Peptide_TABLE, CREATE_PeptideEvidence_TABLE, CREATE_SearchModification_TABLE, CREATE_Modification_TABLE, CREATE_SpectrumIdentification_TABLE, CREATE_Score_TABLE, CREATE_Spectrum_TABLE,CREATE_Peaks_TABLE};
    // Indexes
